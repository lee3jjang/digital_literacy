...
#
#  1. 목적
#   - data 폴더 안에는 미리 준비한 엑셀 파일들이 있고, 각 파일 안에는 일반/장기/자동차 보험의 연월별 보험료, 지급보험금 값이 저장되어 있습니다.
#   - 연월별 보험료(장기/일반/자동차/순외형), 지급보험금(장기/일반/자동차/합계)은 2021년01월부터 2025년12월까지 각 월별 엑셀파일로 저장되어 있습니다.
#   - 이 셀프스터디의 목적은 파이썬(Python)을 이용해 이 파일들을 조작하는 법을 익히는 것입니다. (!! 엑셀파일을 각각 열지 않고 파이썬 내에서 조작 !!)
#
#  2. 셀프스터디 문제 !!
#   → TODO : '2021년'도 '자동차'보험의 '연간 총 보험료' 산출
#            ※ 각 연월별로 저장된 엑셀파일을 각각 열지 않고, 파이썬을 이용하여 산출함
#
#  3. 파이썬 코드 사용 방법
...
#5. 데이터 합치기
보험료보험금_2021년 = pd.concat([보험료보험금_1월, 보험료보험금_2월, 보험료보험금_3월, 보험료보험금_4월, 보험료보험금_5월, 보험료보험금_6월, 보험료보험금_7월, 보험료보험금_8월, 보험료보험금_9월, 보험료보험금_10월, 보험료보험금_11월, 보험료보험금_12월])      # pd.concat([데이터1, 데이터2, ..., 데이터n]) : [데이터1, 데이터2, ..., 데이터n]을 하나로 합침 (모든 파일의 레이아웃이 동일해야 함)
